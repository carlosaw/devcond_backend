...
class UnitController extends Controller
{
  ...
  public function removePerson($id, Request $request) {
    ...
    $idItem = $request->input('id');// id pessoa
    if($idItem) {
      UnitPeople::where('id', $idItem)
      ->where('id_unit', $id)// id unidade
      ->delete();
    } else {
  ...
  public function removeVehicle($id, Request $request) {
    ...
    $idItem = $request->input('id');// id veículo
    if($idItem) {
